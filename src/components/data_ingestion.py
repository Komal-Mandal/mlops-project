...
# Saved as CSV (feature store)
# Split into train & test datasets
# Paths are returned as an artifact



import os  # Creating folders
import sys  # Handling system-level errors

from pandas import DataFrame  # structure for tabular data
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        """
        Initiates the data ingestion pipeline
        """
